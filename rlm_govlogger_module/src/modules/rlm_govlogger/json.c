...
static int json_afrom_value_pair(TALLOC_CTX *ctx, json_object **out,
				 VALUE_PAIR *vp, rlm_govlogger_t const *inst)
{
 ...
 */
static inline char const *attr_name_with_prefix(char *buf, size_t buf_len, const char *name, rlm_govlogger_t const *inst)
{
	int len;
