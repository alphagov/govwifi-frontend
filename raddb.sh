...
aws ${ENDPOINT_ARG} s3 cp ${CERT_STORE_BUCKET}/trusted_certificates/ ${CERTSDIR}/trusted_certificates/ --recursive --exclude "*" --include "*.pem"

# This bit can be removed once CBA dev completed
